...
<header class="navbar navbar-inverse navbar-fixed-top" role="banner">
    ...
    <div class="navbar-header pull-left">
        <a class="" href="/home123" style="color:white" target="_blank">
    ...
    <ul class="nav navbar-nav pull-right toolbar">
        <li class="dropdown">
            ...
            <span class="hidden-xs">@*@Request.Cookies["UName"].Value*@ <i class="fa fa-caret-down"></i>lorem</span><img src="~/AppImage/page/blank-profile.jpg" alt="user pic" /></a>
            <ul class="dropdown-menu userinfo arrow">
                <li class="username">
                    <a href="#">
                        <div class="pull-left"><img src="~/AppImage/page/blank-profile.jpg"
                                                    alt=" user pic" /></div>
                        <div class="pull-right"><h5> @*@Request.Cookies["UName"].Value*@</h5><small>Logged in as <span> @*@Request.Cookies["UType"].Value*@ Admin</span></small></div>
                    </a>
                </li>
                <li class="userlinks">
                    <ul class="dropdown-menu">
                        <li><a href="/admin/pass">Change Password  <i class="pull-right fa fa-pencil"></i></a></li>
                        @*@if (Request.Cookies["UType"] != null)
                        {
                            if (Request.Cookies["UType"].Value == "Teacher")
                            {
                                <li><a href="/TeacherAdmin/PassChange">Password Change <i class="pull-right fa fa-cog"></i></a></li>
                            }
                        }*@
                        ...
                        <li>
                            ...
                            @using (Html.BeginForm("LogOffAdmin", "ksJns76HNhpqtwgHGats5", FormMethod.Post, new { id = "LogoutUser" }))
                            {@Html.AntiForgeryToken()
                            <a href="#" onclick="document.getElementById('LogoutUser').submit();" class="text-right" style="float:right;margin-right:2%;color:black">Sign Out</a>
                        }
